...
secret_message = [
    'вкевтфпп6щ3стмзалтнмаршгб5длгуча',
...
"Задание кривое, так как в уроке он нихуя не правильно сказал, " \
"нельзя обратно индексировать обычные строки, пришлось дополнительно гуглить"
